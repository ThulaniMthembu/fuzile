...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-md space-y-4 text-center mb-6">
        <h1 className="text-4xl font-bold tracking-tight text-[#fca311] animate-fade-in">
          Welcome Back Fuzile...
        </h1>
      ...
      <Card className="w-full max-w-md border-0 bg-[#14213d] backdrop-blur-sm shadow-xl transition-all duration-300 hover:shadow-2xl hover:scale-[1.01]">
        ...
        <CardContent className="space-y-4 relative">
          {authError && (
            <div className="bg-red-900/20 text-red-400 text-sm p-3 rounded-md flex items-center animate-shake">
      ...
      <div className="w-full max-w-md space-y-4 text-center mt-6">
        <h1 className="text-3xl font-bold tracking-tight text-[#fca311] animate-fade-in">
